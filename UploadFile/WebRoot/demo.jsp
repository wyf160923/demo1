...
%>    
<%
	//String Path = contextPath.concat("/server/pages/Mgtbasic");
...
<body>  
    ...
    <form name="userForm1" action="/pictureUpload" enctype="multipart/form-data" method="post">  
        <div id="newUpload1">  
    ...
    <form name="userForm2" action="<%=basePath%>/api/Upload/pictureUpload" enctype="multipart/form-data" method="post"">  
        <div id="newUpload2">  
            <input type="file" name="file">  
        </div>  
